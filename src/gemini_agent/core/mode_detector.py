...
class ModeDetector:
    ...
    """
    WEB_SEARCH_KEYWORDS = [
        'current', 'latest', 'news', 'today', 'yesterday', 'recent',
        'weather', 'stock', 'price', 'market', 'sports', 'score',
        'who is', 'what is', 'when was', 'where is', 'how to',
        'update', 'breaking', 'live', 'trending', 'covid', 'virus',
        'president', 'election', 'world cup', 'oscars', 'nobel'
    ]
    
    LOCAL_OPS_KEYWORDS = [
        'file', 'directory', 'folder', 'read', 'write', 'create',
        'delete', 'modify', 'edit', 'code', 'python', 'script',
        'run', 'execute', 'debug', 'test', 'analyze', 'refactor',
        'process', 'list', 'show', 'display', 'git', 'commit',
        'install', 'package', 'dependency', 'system', 'process',
        'kill', 'start', 'application', 'program'
    ]
